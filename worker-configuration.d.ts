/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3d705dc58963f6c797d3f8ff06c13ce)
// Runtime types generated with workerd@1.20260212.0 2025-12-21 nodejs_compat_v2
declare namespace Cloudflare {
	...
	interface StagingEnv {
		METRICS: KVNamespace;
		STORAGE: KVNamespace;
		X402_FACILITATOR_URL: "https://x402-relay.aibtc.dev";
		X402_SERVER_ADDRESS: "ST31JEZWX4S131326VKM05QKJ0TDGNVVE0DGNM4BP";
		X402_NETWORK: string;
		X402_PK: string;
		X402_CLIENT_PK: string;
		X402_WORKER_URL: string;
		CLOUDFLARE_API_TOKEN: string;
		USER_DO: DurableObjectNamespace<import("./src/index").UserDurableObject>;
		LOGS: Service /* entrypoint LogsRPC from worker-logs */;
	}
	interface Env {
		X402_NETWORK: string;
		X402_PK: string;
		...
		METRICS: KVNamespace;
		STORAGE: KVNamespace;
		X402_FACILITATOR_URL: "https://x402-relay.aibtc.dev" | "https://x402-relay.aibtc.com";
		X402_SERVER_ADDRESS: "ST31JEZWX4S131326VKM05QKJ0TDGNVVE0DGNM4BP" | "SP31JEZWX4S131326VKM05QKJ0TDGNVVE0CDWWVA2";
		USER_DO: DurableObjectNamespace<import("./src/index").UserDurableObject>;
		LOGS: Service /* entrypoint LogsRPC from worker-logs */;
	}
}
