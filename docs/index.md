...
STX402 Directory is a Cloudflare Workers API providing **36 endpoints** across 4 categories. Each paid endpoint accepts micropayments using STX, sBTC, or USDCx via the X402 protocol.
...
|----------|-------|--------------|-------------|
| [Info](src/endpoints.md#info) | 5 | `/health`, `/dashboard`, `/guide`, `/toolbox`, `/x402.json` | Service info & docs (free) |
